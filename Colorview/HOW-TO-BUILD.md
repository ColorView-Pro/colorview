...
1. Put this whole `electron-app` folder into your GitHub repo (same repo as
...
3. On GitHub, go to your repo → **Actions** tab. You'll see a workflow
   ...
   any time you push changes inside `electron-app/`).
...
2. Open a terminal in this `electron-app` folder.
3. Run:
   ```
   npm install
   npm run dist
...
copy the updated files into `electron-app/app/` too, then rebuild (push again
